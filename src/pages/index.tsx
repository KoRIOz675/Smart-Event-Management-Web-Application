...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      <Head>
        <title>SmartEvent | {t.heroTitle1} {t.heroTitle2}</title>
        ...
        <section className="py-32 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-3xl md:text-4xl font-black mb-4">{t.solutionTitle}</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="bg-card p-10 rounded-radius-4xl border border-border shadow-sm hover:shadow-md transition group">
                ...
                <h3 className="text-2xl font-bold mb-6">{t.organizersTitle}</h3>
                <ul className="space-y-4">
                  {t.organizersFeatures.map((item, i) => (
              ...
              <div className="bg-card p-10 rounded-radius-4xl border border-border shadow-sm hover:shadow-md transition group">
                ...
                <h3 className="text-2xl font-bold mb-6">{t.participantsTitle}</h3>
                <ul className="space-y-4">
                  {t.participantsFeatures.map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-muted-foreground italic">
